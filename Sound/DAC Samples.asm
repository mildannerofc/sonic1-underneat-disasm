...
;			| Filename	| Folder
    ...
    if SMPS_S3DACSamples||SMPS_SKDACSamples||SMPS_S3DDACSamples
		incdac	SnareS3, "Sound/DAC/Sonic 1 Mixed by Hame/Sonic3HQSnare(26050Hz).wav"
		incdac	TomS3, "Sound/DAC/Sonic 3 & K & 3D/TomS3.pcm"
		incdac	KickS3, "Sound/DAC/Sonic 1 Mixed by Hame/Sonic3HQKick(26050Hz).wav"
		incdac	MuffledSnare, "Sound/DAC/Sonic 1 Mixed by Hame/Sonic3HQSnare(26050Hz).wav"
		incdac	CrashCymbal, "Sound/DAC/Sonic 1 Mixed by Hame/Cymbal(22050Hz).wav"
		...
		incdac	ClapS3, "Sound/DAC/Sonic 1 Mixed by Hame/Clap(22050Hz).wav"
